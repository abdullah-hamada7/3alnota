...
**Tests**: Unit tests are MANDATORY for every feature and change. Include them for each user story and for shared financial logic.
...
- [ ] T010 [P] [US1] Unit test core story logic in tests/unit/test_[name].py
...
- [ ] T019 [US1] Verify mobile-first behavior at the smallest supported viewport
...
- [ ] T020 [P] [US2] Unit test core story logic in tests/unit/test_[name].py
...
- [ ] T027 [P] [US3] Unit test core story logic in tests/unit/test_[name].py
...
Task: "Unit test core story logic in tests/unit/test_[name].py"
...
- Verify monetary logic uses decimal types and calculation paths stay within O(n log n)
